...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference("Association.count") do
      post associations_url, params: { association: { athlete_id: @association.athlete_id, fan_id: @association.fan_id } }
    end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { athlete_id: @association.athlete_id, fan_id: @association.fan_id } }
