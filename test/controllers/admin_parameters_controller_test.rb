...
class AdminParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_parameter" do
    assert_difference("AdminParameter.count") do
      post admin_parameters_url, params: { admin_parameter: { remuneration: @admin_parameter.remuneration } }
    end
  ...
  test "should update admin_parameter" do
    patch admin_parameter_url(@admin_parameter), params: { admin_parameter: { remuneration: @admin_parameter.remuneration } }
