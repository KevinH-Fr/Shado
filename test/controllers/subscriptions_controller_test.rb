...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference("Subscription.count") do
      post subscriptions_url, params: { subscription: { campaign_id: @subscription.campaign_id, fan_id: @subscription.fan_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { campaign_id: @subscription.campaign_id, fan_id: @subscription.fan_id } }
